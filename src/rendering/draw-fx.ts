import type { GameState, Particle, FloatingText, SunBurst } from '../game';

export function drawParticles(ctx: CanvasRenderingContext2D, particles: Particle[], lowPerformance: boolean): void {
...
export function drawFloatingTexts(ctx: CanvasRenderingContext2D, floatingTexts: FloatingText[], lowPerformance: boolean): void {
...
export function drawPortal(ctx: CanvasRenderingContext2D, state: GameState, internalW: number, internalH: number): void {
